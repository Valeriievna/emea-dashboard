...
G2_NORTH = [
    # ── High ──
    dict(co="ESP Systex", ctry="United Kingdom", activity="High", visitor="United Kingdom", last="~9 days ago", days=9, visitors=None, signals=9),
    ...
    dict(co="Lightdash", ctry="United Kingdom", activity="High", visitor="Poland", last="~5 weeks ago", days=34, visitors=None, signals=3),
    dict(co="WP Media", ctry="Poland", activity="High", visitor="Poland", last="~3 months ago", days=79, visitors=None, signals=14),
    # ── Medium ──
    ...
    dict(co="HOSI Wien", ctry="Austria", activity="Medium", visitor="Hungary", last="~9 days ago", days=9, visitors=None, signals=13),
    ...
    dict(co="Zangenberg & Partners", ctry="Denmark", activity="Medium", visitor="Denmark", last="~15 days ago", days=15, visitors=None, signals=4),
    ...
    dict(co="Ding", ctry="Sweden", activity="Medium", visitor="Bulgaria", last="~3 weeks ago", days=19, visitors=None, signals=3),
    dict(co="RemoteMore", ctry="Germany", activity="Medium", visitor="Bulgaria", last="~3 weeks ago", days=19, visitors=None, signals=4),
    dict(co="Acronis", ctry="Switzerland", activity="Medium", visitor="Serbia", last="~3 weeks ago", days=20, visitors=None, signals=4),
    dict(co="IBL Software Engineering", ctry="Slovakia", activity="Medium", visitor="Poland", last="~3 weeks ago", days=21, visitors=None, signals=6),
    ...
    dict(co="Softpedia", ctry="Romania", activity="Medium", visitor="Romania", last="~5 weeks ago", days=32, visitors=None, signals=4),
    dict(co="Hungarian Testing Board", ctry="Hungary", activity="Medium", visitor="Hungary", last="~5 weeks ago", days=36, visitors=None, signals=5),
    ...
    dict(co="O2", ctry="Poland", activity="Medium", visitor="Poland", last="~6 weeks ago", days=41, visitors=None, signals=5),
    dict(co="International School of English", ctry="Sweden", activity="Medium", visitor="Sweden", last="~6 weeks ago", days=42, visitors=None, signals=4),
    ...
    dict(co="Caeli Nova", ctry="United Kingdom", activity="Medium", visitor="United Kingdom", last="~3 months ago", days=76, visitors=None, signals=6),
]
...
G2_SOUTH = [
    ...
    dict(co="Aqwas", ctry="Saudi Arabia", activity="High", visitor="France", last="~3 weeks ago", days=19, visitors=None, signals=10),
    dict(co="Naval Group", ctry="France", activity="High", visitor="France", last="~5 weeks ago", days=32, visitors=None, signals=6),
    dict(co="Trafi", ctry="France", activity="High", visitor="Poland", last="~6 weeks ago", days=40, visitors=None, signals=7),
    ...
    dict(co="Lebanese American University", ctry="Lebanon", activity="Medium", visitor="Lebanon", last="~10 days ago", days=10, visitors=None, signals=4),
    ...
    dict(co="Ruth & Bruce Rappaport Faculty Of Medicine", ctry="Israel", activity="Medium", visitor="Israel", last="~6 weeks ago", days=42, visitors=None, signals=5),
    dict(co="GadgetLine", ctry="Israel", activity="Medium", visitor="Israel", last="~2 months ago", days=45, visitors=None, signals=5),
    ...
    dict(co="VistaCreate", ctry="Cyprus", activity="Medium", visitor="Tunisia", last="~2 months ago", days=61, visitors=None, signals=4),
    dict(co="TiTrias", ctry="Egypt", activity="Medium", visitor="Egypt", last="~2 months ago", days=73, visitors=None, signals=6),
    dict(co="شركة عبر المملكة العقارية", ctry="Saudi Arabia", activity="Medium", visitor="Saudi Arabia", last="~2 months ago", days=74, visitors=None, signals=4),
