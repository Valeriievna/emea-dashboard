...
UNIFY_NORTH = [
    # views = performance + leads table impressions combined
    dict(co="SAP",                   ctry="Germany",     ch=["Ads"], views=385, clicks=9,    ctr=2.34, op=None, lead=None, ltitle=None, ldate=None),
    dict(co="Siemens",               ctry="Germany",     ch=["Ads"], views=333, clicks=3,    ctr=0.90, op=None, lead=None, ltitle=None, ldate=None),
    dict(co="Ericsson",              ctry="Sweden",      ch=["Ads"], views=182, clicks=None, ctr=None, op=None, lead=None, ltitle=None, ldate=None),
    dict(co="Volvo Cars",            ctry="Sweden",      ch=["Ads"], views=174, clicks=None, ctr=None, op=None, lead=None, ltitle=None, ldate=None),
    dict(co="Bosch",                 ctry="Germany",     ch=["Ads"], views=168, clicks=4,    ctr=2.38, op=None, lead=None, ltitle=None, ldate=None),
    dict(co="BASF",                  ctry="Germany",     ch=["Ads"], views=157, clicks=None, ctr=None, op=None, lead=None, ltitle=None, ldate=None),
    dict(co="AUMOVIO",               ctry="Europe",      ch=["Ads"], views=133, clicks=None, ctr=None, op=None, lead=None, ltitle=None, ldate=None),
    dict(co="Zalando",               ctry="Germany",     ch=["Ads"], views=132, clicks=None, ctr=None, op=None, lead=None, ltitle=None, ldate=None),
    dict(co="IKEA",                  ctry="Sweden",      ch=["Ads"], views=118, clicks=None, ctr=None, op=None, lead=None, ltitle=None, ldate=None),
    dict(co="Nokia",                 ctry="Finland",     ch=["Ads"], views=95,  clicks=None, ctr=None, op=None, lead=None, ltitle=None, ldate=None),
    dict(co="Volvo Group",           ctry="Sweden",      ch=["Ads"], views=93,  clicks=None, ctr=None, op=None, lead=None, ltitle=None, ldate=None),
    dict(co="Infineon Technologies", ctry="Germany",     ch=["Ads"], views=91,  clicks=None, ctr=None, op=None, lead=None, ltitle=None, ldate=None),
    dict(co="ASML",                  ctry="Netherlands", ch=["Ads"], views=84,  clicks=None, ctr=None, op=None, lead=None, ltitle=None, ldate=None),
    dict(co="Continental",           ctry="Germany",     ch=["Ads"], views=84,  clicks=None, ctr=None, op=None, lead=None, ltitle=None, ldate=None),
    ...
    dict(co="Eaton",                 ctry="Ireland",     ch=["Ads"], views=73,  clicks=None, ctr=None, op=None, lead=None, ltitle=None, ldate=None),
    dict(co="Vodafone",              ctry="UK",          ch=["Ads"], views=111, clicks=None, ctr=None, op=None, lead=None, ltitle=None, ldate=None),
    dict(co="Deutsche Bank",         ctry="Germany",     ch=["Ads"], views=111, clicks=3,    ctr=2.70, op=None, lead=None, ltitle=None, ldate=None),
    dict(co="UBS",                   ctry="Switzerland", ch=["Ads"], views=101, clicks=None, ctr=None, op=None, lead=None, ltitle=None, ldate=None),
    dict(co="Shell",                 ctry="Netherlands", ch=["Ads"], views=100, clicks=None, ctr=None, op=None, lead=None, ltitle=None, ldate=None),
